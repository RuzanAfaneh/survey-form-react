  ...
  return (
    <div className="formContainer">
      <form className="question form  radio">
        ...
        <label><input name="satisfaction" type="radio" value="Quite Satisfied"  onChange={e=>setValues({...values, firstName:e.target.value} )}values={values ?values.satisfaction :''} required />Quite Satisfied<span class="checkMark"></span></label>
        <label><input name="satisfaction" type="radio" value="Satisfied"  onChange={e=>setValues({...values, firstName:e.target.value} )}values={values ?values.satisfaction :''} required /> Satisfied<span class="checkMark"></span></label>
        <label><input name="satisfaction" type="radio" value="Completely Satisfied"  onChange={e=>setValues({...values, firstName:e.target.value} )}values={values ?values.satisfaction :''}required /> Completely Satisfied<span class="checkMark"></span>
        </label>
      </form>
    </div>
  );
